  ...
  try {
    ...
    */
    ...
    const tenantValues = [
      ...
      { name: 'Zyncrox Test Studio', slug: 'test', whatsappNumber: '50300000000', timezone: 'America/El_Salvador', status: 'ACTIVE' as const, primaryColor: '#000000', plan: 'PRO' as const }
    ];
