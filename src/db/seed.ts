...
async function main() {
  ...
  try {
    ...
    */
    ...
    const tenantValues = [
      { name: 'ZyncSalón Spa', slug: 'zyncsalon-spa', whatsappNumber: '50370000000', timezone: 'America/El_Salvador', status: 'ACTIVE' as const, plan: 'PROFESSIONAL' as const },
      { name: 'Zyncrox Test Studio', slug: 'test', whatsappNumber: '50300000000', timezone: 'America/El_Salvador', status: 'ACTIVE' as const, primaryColor: '#000000', plan: 'PROFESSIONAL' as const }
    ];
